    ...
    <section id="about" className="py-16 lg:py-24 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollAnimation animation="fadeUp" delay={0.2} className="prose prose-lg max-w-none text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <ScrollAnimation animation="fadeUp" delay={0.4} className="text-center p-6 rounded-lg bg-card border border-border/50">
            ...
            <ScrollAnimation animation="fadeUp" delay={0.6} className="text-center p-6 rounded-lg bg-card border border-border/50">
              <div className="mx-auto mb-4 p-3 rounded-lg bg-primary/10 w-fit">
                <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ScrollAnimation animation="fadeUp" delay={0.8} className="text-center p-6 rounded-lg bg-card border border-border/50">
              <div className="mx-auto mb-4 p-3 rounded-lg bg-primary/10 w-fit">
                <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <ScrollAnimation animation="fadeUp" delay={1.0} className="text-center">
            <Button 
              size="lg"
