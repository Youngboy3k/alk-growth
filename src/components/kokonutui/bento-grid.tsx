        ...
        <div className="w-full py-4">
            <div className="relative max-w-xl w-full mx-auto flex items-center flex-col gap-2">
                ...
                >
                    {submitted ? (
                        <div
                            className="w-6 h-6 rounded-sm animate-spin-slow bg-black dark:bg-white cursor-pointer pointer-events-auto"
                        />
                    ) : (
                    ...
                    {[...Array(48)].map((_, i) => (
                        <div
                            ...
                            className={cn(
                                ...
                                submitted && isClient && "animate-voice-bar",
                                submitted && isClient && `delay-[${i * 50}ms]`
                            )}
                        />
                    ))}
                </div>
...
const BentoCard = ({ item }: { item: BentoItem }) => {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className="relative z-10 flex flex-col gap-3 h-full transform-gpu"
                >
