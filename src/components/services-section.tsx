...
const services = [
  {
    ...
    description: "Custom responsive design with AI-optimized performance, mobile-first approach, and conversion optimization for new and existing websites.",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19c-5.5 0-10-4.5-10-10s4.5-10 10-10 10 4.5 10 10-4.5 10-10 10z" />
